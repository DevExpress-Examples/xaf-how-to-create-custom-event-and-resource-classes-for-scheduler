...
#Region "Resources"
        ...
        Private Sub UpdateResource()
            ...
            If Not String.IsNullOrEmpty(resourceIdField) Then
                ...
                For Each xmlNode As XmlNode In xmlDocument.DocumentElement.ChildNodes
                    ...
                    Dim obj As Object = ObjectSpace.GetObjectByKey(GetType(CustomResource), keyMemberValue)
                    If obj IsNot Nothing Then
                        Resource = CType(obj, CustomResource)
                    End If
                Next
            End If
        End Sub
        ...
        Public Overridable Property Resource As CustomResource
...
#Region "IRecurrentEvent"
        <Browsable(False)>
        Public Overridable Property RecurrencePatternProp As CustomEventWithCustomResource

        <Browsable(False)>
        Public Overridable Property RecurrenceEvents As IList(Of CustomEventWithCustomResource) = New ObservableCollection(Of CustomEventWithCustomResource)()
        ...
        Private Property RecurrencePattern As IRecurrentEvent Implements IRecurrentEvent.RecurrencePattern
            ...
            Set(ByVal value As IRecurrentEvent)
                RecurrencePatternProp = CType(value, CustomEventWithCustomResource)
            End Set
        End Property
...
#Region "Blazor compatibility"
        ...
        Public Property ResourceIdBlazor As Object
            ...
            Set(ByVal value As Object)
                Resource = Nothing
                If value IsNot Nothing Then
                    Resource = ObjectSpace.GetObjectByKey(Of CustomResource)(value)
                End If
            End Set
        End Property
