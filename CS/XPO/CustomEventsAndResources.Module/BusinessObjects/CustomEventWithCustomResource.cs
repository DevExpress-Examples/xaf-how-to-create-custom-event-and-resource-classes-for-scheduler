...
[DefaultClassOptions]
public class CustomEventWithCustomResource : BaseObject, IEvent, IRecurrentEvent, IReminderEvent {
    ...
    private void UpdateResource() {
        ...
        if (!String.IsNullOrEmpty(resourceIds)) {
            ...
            foreach (XmlNode xmlNode in xmlDocument.DocumentElement.ChildNodes) {
                ...
                CustomResource resource = Session.GetObjectByKey<CustomResource>(new Guid(keyMemberValue.ToString()));
                if (resource != null) {
                    Resource = resource;
                }
            }
    ...
    private CustomEventWithCustomResource recurrencePattern;
    ...
    public IRecurrentEvent RecurrencePattern {
        ...
        set { SetPropertyValue(nameof(RecurrencePattern), ref recurrencePattern, (CustomEventWithCustomResource)value); }
    }
    #endregion
    ...
    #endregion
    #region Construction
    public CustomEventWithCustomResource(Session session)
    : base(session) {
    }
