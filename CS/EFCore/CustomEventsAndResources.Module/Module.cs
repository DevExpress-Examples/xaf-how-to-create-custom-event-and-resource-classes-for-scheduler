...
namespace CustomEventsAndResources.Module;

// For more typical usage scenarios, be sure to check out https://docs.devexpress.com/eXpressAppFramework/DevExpress.ExpressApp.ModuleBase.
public sealed class CustomEventsAndResourcesModule : ModuleBase {
    public CustomEventsAndResourcesModule() {
		// 
		// CustomEventsAndResourcesModule
		// 
		AdditionalExportedTypes.Add(typeof(CustomEventsAndResources.Module.BusinessObjects.ApplicationUser));
